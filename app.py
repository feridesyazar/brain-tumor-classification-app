...
# Download the trained model directly from Hugging Face Space
MODEL_PATH = hf_hub_download(
    repo_id="ferides/brain-tumor-classification-app",
    filename="brain_tumor_mri_model.keras",
    repo_type="space"
)
...
body {
    ...
    background:
        radial-gradient(
            circle at top left,
            rgba(184, 214, 245, 0.65) 0%,
            transparent 26%
        ),
        radial-gradient(
            circle at top right,
            rgba(198, 222, 248, 0.50) 0%,
            transparent 24%
        ),
        linear-gradient(
            135deg,
